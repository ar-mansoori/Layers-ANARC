...
const Page1 = () => {
  ...
  return (
    ...
    >
      ...
      {/* Titles */}
      <div className="flex z-0 bg-none sm:block absolute bottom-52 left-1/2 -translate-x-1/2 sm:top-36 sm:left-0 sm:translate-x-0 sm:w-1/2 h-fit w-fit backdrop-blur-sm sm:backdrop-blur-none rounded-lg text-white">
        <div
          ref={t1Ref}
